        ...
        <div class="bg-gradient-to-r from-purple-800 to-indigo-800 py-12 px-4">
            <div class="max-w-screen-xl mx-auto">
                <div class="max-w-3xl mx-auto mb-16 text-center">
                    <h2 class="text-white text-3xl lg:text-4xl font-bold text-center mb-4 leading-relaxed">Features of Projects</h2>
                    <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">This project combines three frontend tasks using React and Tailwind CSS. It highlights skills in API integration, state management, and routing with react-router-dom, built as part of the Codexintern frontend internship.</p>
                </div>
                <div class="grid lg:grid-cols-3 md:grid-cols-2 mx-auto">
                    <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Personalize the translator output, string length, and interface according to your preferences. Built with flexibility in mind using React and Tailwind CSS.</p>
                    </div>
                    ...
                    <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <h3 class="text-lg font-semibold mb-3">Secure API Integration</h3>
                        <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Translation is powered by RapidAPI, ensuring secure communication and protection of user inputs using industry-standard API protocols.</p>
                    </div>
                    ...
                    <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Clear code structure, modular components, and React hooks make it easy for developers to understand, extend, or integrate this project into other tools.</p>
                    </div>
                    ...
                    <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <h3 class="text-lg font-semibold mb-3">Optimized Performance</h3>
                        <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Experience instant translations and string generation with efficient state handling using React Hooks like useState, useEffect, and useCallback.</p>
                    </div>
                    ...
                    <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <h3 class="text-lg font-semibold mb-3">Multi-language Access</h3>
                        <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Translate text into multiple global languages, making it perfect for international users or developers working on multilingual platforms.</p>
                    </div>
                    ...
                    <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <h3 class="text-lg font-semibold mb-3">Easy Navigation</h3>
                        <p class="text-slate-300 group-hover:text-slate-600 text-sm leading-relaxed">Implemented with client-side routing using React Router, the project ensures smooth transitions between pages without full reloads.</p>
                    </div>
                </div>
            </div>
        </div>
